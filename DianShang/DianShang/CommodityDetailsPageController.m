...
- (void)viewDidLoad
{
    ...
    //设置UITableView 上拉加载
    self.cdpTableView.footer = [MJRefreshBackNormalFooter footerWithRefreshingBlock:^{
    ...
    //设置UIWebView 有下拉操作
    self.cdpWebView.scrollView.header = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        //下拉执行对应的操作
...
-(UITableView *)cdpTableView
{
    ...
    {
        _cdpTableView = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, IPHONE_W, IPHONE_H) style:UITableViewStylePlain];
